...
// func SetupZkCustDB(channelName string) (*bolt.DB, error) {
// 	BucketName := []byte(channelName)
...
// func AddCustState(db *bolt.DB, channelName string, custStateBytes []byte) error {
// 	BucketName := []byte(channelName)
...
// func AddCustField(db *bolt.DB, channelName string, fieldBytes []byte, fieldName string) error {
// 	BucketName := []byte(channelName)
...
// func GetCustState(db *bolt.DB, channelName string) ([]byte, error) {
// 	BucketName := []byte(channelName)
// 	var fieldBytes []byte
...
// func GetCustField(db *bolt.DB, channelName string, fieldName string) ([]byte, error) {
// 	BucketName := []byte(channelName)
